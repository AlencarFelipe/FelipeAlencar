...
# Criar uma tabela chamada cliente_vip
...
def delete_cliente(idcliente):
    query = 'DELETE FROM cliente_vip WHERE idlciente = %s'
    values = (idcliente)
    cursor.execute(query, values)

# Exemplo de uso:

inserir_cliente('Victor', 'Rua do Senai', '123456789', 'victor@felipe', '987654321')
